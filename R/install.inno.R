...
#' 
#' @description Downloads and installs Inno Setup's \href{https://jrsoftware.org/isdl.php#stable}{stable release}
#' 
#' @details
...
#' 
#' @param quick_start_pack logical (default is FALSE) - The Inno Setup QuickStart Pack includes Inno Setup and Inno Script Studio script editor. See \href{https://jrsoftware.org/is3rdparty.php}{Third-Party Files} page for more information.
...
install.inno <- function(
  ...
  page_with_download_url = 'https://jrsoftware.org/download.php/' 
  exe_filename = 'is.exe'
  ...
  if (encryption_module) {
    ...
    temp <- tempfile()
    utils::download.file("https://jrsoftware.org/download.php/iscrypt.dll", temp, mode = 'wb')
